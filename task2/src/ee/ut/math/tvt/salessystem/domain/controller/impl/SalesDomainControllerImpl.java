...
public class SalesDomainControllerImpl implements SalesDomainController {
    ...
    // Task 2. Refactoring: Replace the method submitCurrentPurchase(List<SoldItem> goods, Client currentClient) 
    ...
    public void registerSale(Sale sale) {
        ...
        for (SoldItem item : sale.getSoldItems()) { //for (SoldItem item : soldItems) {
        ...
        log.info("Purchase registered"); // line added
