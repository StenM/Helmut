...
public class HistoryTab {
    ...
    private final SalesDomainController controller; // line added
    ...
    public HistoryTab(SalesSystemModel model, SalesDomainController controller) { // public HistoryTab(SalesSystemModel model) {
        this.model = model;
        this.controller = controller; // line added
    }
    ...
    // lines below added
    public void refresh() {
    	PurchaseHistoryTableModel phtm = model.getPurchaseHistoryTableModel();
    	phtm.populateWithData(controller.getAllSales());
    	phtm.fireTableDataChanged();
