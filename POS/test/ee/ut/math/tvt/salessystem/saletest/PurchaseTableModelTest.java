package ee.ut.math.tvt.salessystem.saletest;
...
public class PurchaseTableModelTest {
	...
	public void testGetSumWithOneItem() {
		purchaseTable.addItem(sold1);
		assertEquals(purchaseTable.getSum(),
				sold1.getPrice() * sold1.getQuantity(), 0.001);
	}
	...
	public void testGetSumWithMultipleItems() {
		...
		double correct = sold1.getPrice() * sold1.getQuantity()
				+ sold2.getPrice() * sold2.getQuantity();
	...
	public void testGetItemByName() {
		purchaseTable.addItem(sold1);
		assertEquals(purchaseTable.getItemByName("Tere"), sold1);
	}
